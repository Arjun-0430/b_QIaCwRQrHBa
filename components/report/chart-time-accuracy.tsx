...
export function ChartTimeAccuracy({ sections }: ChartTimeAccuracyProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border border-sky-200 bg-gradient-to-br from-sky-50 to-blue-50/50 p-5">
      ...
      >
        <defs>
          {sections.map((section, i) => {
            ...
            return (
              <linearGradient key={i} id={`point-gradient-${i}`} x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          return (
            <g key={section.key}>
              ...
              <text
                ...
                fontWeight="500"
              >
                {section.label.length > 10
                  ? section.label.slice(0, 9) + "..."
                  : section.label}
              </text>
            </g>
          );
